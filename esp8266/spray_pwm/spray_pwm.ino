/*
  ...
  PC commands:
    ...
    SET_DUTY <0-1023> -> OK  (set PWM duty cycle)
    SET_FREQ <100-10000> -> OK  (set PWM frequency in Hz)
    GET_PWM -> duty_left,duty_right,freq
...
// Default frequency: 1000Hz (can be changed with SET_FREQ)
int pwmFreq = 1000;
...
void setPWMFrequency(int freq) {
  // Constrain frequency to safe range
